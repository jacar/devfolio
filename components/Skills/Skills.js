        ...
        <div className="flex flex-col skills-wrapper">
          <div className="flex flex-col">
            ...
            <h1 className="text-6xl mt-2 font-medium text-gradient w-fit staggered-reveal">
              Soy un desarrollador WordPress
            </h1>
            <h2 className="text-[1.65rem] font-medium md:max-w-lg w-full mt-2 staggered-reveal">
              Me especializo en crear sitios web optimizados y funcionales utilizando WordPress. Me apasiona crear experiencias visuales impresionantes, enfocándome en la facilidad de uso y la optimización del rendimiento.
            </h2>
          </div>
          <div className="mt-10">
